...
// Récupère les résultats des matchs TERMINÉS depuis football-data.org et les
// injecte dans la table "results". Réservé à l'admin.
//
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return json(200, { ok: true, fetched: apiMatches.length, saved, unmatched });
